                    ...
                    <div className="flex flex-col items-center">
                        <div className=" bg-white rounded-2xl shadow-xl  flex  flex-col justify-around items-center -mt-48 py-9 mb-4 w-11/12 md:flex-row lg:-mt-56">
                            ...
                            <div className="flex flex-col">
                                ...
                                <label htmlFor="userType" className="font-primary  text-md font-semibold  mt-6">User Type</label>
                                ...
                                <div className='d-flex flex-col my-5'>
                                    <label htmlFor="password" className={addOrUpdate === 'Add' ? "hidden" : "font-primary  text-md font-semibold  mt-6"}>Reset Password</label>
                                    <Field id="password" type="checkbox" name="password" className={addOrUpdate === 'Add' ? "hidden" : "ml-10"} />
                                </div>
                                ...
                                {addOrUpdate === 'Add' ?
                                    <span className='mt-3 text-sm '>Default Password is Staff123</span> :
                                    <span className='mt-3 text-sm '>New Password is Staff123</span>
                                }
                            </div>
