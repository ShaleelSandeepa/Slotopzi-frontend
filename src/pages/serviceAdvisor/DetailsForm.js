...
export default function DetailsForm() {
  ...
  const getUserDetails = () => {
    ...
    if (contactNo != "") {
      axios
        .get(
          `${process.env.REACT_APP_API_BASE_URL}/advisor/getCustomer/${contactNo}`,
          config
        )
        .then(async function (response) {
          ...
          setvehicleNumbers(
            response.data.vehicleList.map((vehicle) => (
          ...
          document
            .getElementById("add-new-vehicle-btn")
        ...
        .catch(function (error) {
          ...
          setvehicleNumbers();
          document
            .getElementById("customer-add-btn")
            .classList.remove("hidden");
            ...
            <div className="grid-cols-4 ">
              <div className="w-full h-24">
                <div className="flex items-center justify-center w-full mt-20">
                  <div className="flex flex-col mr-2">
                    <label
                      htmlFor="contactNo"
                      className="font-primary  text-xl text-white font-semibold  mt-3"
                    >
                      Contact No{" "}
                    </label>
                    <input
                      ...
                      placeholder="+94/07....."
                      className="mt-2 rounded-lg shadow-lg w-80 h-20 pl-5"
                    />
                  </div>
                  <div className="ml-8 mt-14">
                    <SearchBtnDetailsForm
              ...
              <Formik
                ...
                onSubmit={async (values, { resetForm }) => {
                  ...
                  axios
                    .post(
                      `${process.env.REACT_APP_API_BASE_URL}/advisor/customer/addNew`,
                      values,
                      config
                    )
              ...
              >
                <Form className="mt-20 mr-12">
                    ...
                    <div className="w-full xl:w-8/12 bg-white p-12 rounded-xl flex flex-col items-center overflow-auto ">
                      <div className="flex flex-row spay-3">
                        <div className="flex flex-col mr-12 ml-4 w-1/2">
                          ...
                          <label
                            htmlFor="firstName"
                            className="font-primary  text-md font-semibold  mt-3"
                          >
                            First Name
                          </label>
                          <Field
                            ...
                            required
                            name="firstName"
                            placeholder="Jane Irish"
                            disabled={disable}
                            className=" ml-5 mt-2 rounded-lg shadow-lg w-60 h-10 pl-5"
                          />
                          ...
                          <Field
                            ...
                            required
                            name="address"
                            placeholder="1/d, Negombo,Colombo"
                            disabled={disable}
                            className=" ml-5 mt-2 rounded-lg shadow-lg w-60 h-10 pl-5"
                          />
                        </div>
                        <div className="flex flex-col md:ml-20 lg:ml-28 xl:ml-32 w-1/2">
                          ...
                          <Field
                            ...
                            placeholder="Jane"
                            disabled={disable}
                            className=" ml-5 rounded-lg shadow-lg w-60 h-10  mt-2 pl-5"
                          />
                  ...
                  <div className="w-full mt-12">{vehicleNumbers}</div>
                  ...
                  <div className="flex justify-center  items-center h-18 mt-12">
                    ...
                    >
                      <button
                        className="bg-green-600 w-48 h-12 rounded-xl text-white text-xl mt-2 mr-8"
                        type="submit"
                      >
                        Add Customer
                      </button>
              ...
              <div className="flex justify-center mt-8 mb-40">
                ...
                >
                  <button
                    id="add-new-vehicle-btn"
                    className=" bg-gradient-to-r from-red-400 to-yellow-500 w-48 h-12 rounded-xl text-white text-xl mt-2 mr-8 hidden"
                  >
                    Add New Vehicle
                  </button>
                </Link>
